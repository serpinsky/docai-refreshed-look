...
Верни ТОЛЬКО валидный JSON объект без дополнительного текста в следующем формате:
{
  ...
  "category": "категория документа - выбери ОДНУ из: Договоры, Счета, Акты, Накладные, Платежные документы, Юридические документы, Кадровые документы, Прочее",
...
- "Договоры": договоры поставки, аренды, подряда, оказания услуг, купли-продажи
- "Счета": счета на оплату, счета-фактуры
- "Акты": акты выполненных работ, акты приема-передачи, акты сверки
- "Накладные": товарные накладные, транспортные накладные
- "Платежные документы": платежные поручения, банковские выписки, квитанции
- "Юридические документы": доверенности, заявления, уставы, решения
- "Кадровые документы": приказы, трудовые договоры, заявления сотрудников
- "Прочее": если не подходит ни под одну категорию`;
